...
export default function TransferNews() {
  ...
  const handleFetchNews = async () => {
    setIsFetching(true);
    try {
      const res = await base44.functions.invoke("fetchTransferNews", {});
      toast({
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-start gap-2 p-3 bg-blue-50 dark:bg-blue-950 rounded-lg text-sm text-blue-700 dark:text-blue-300">
        ...
        <span>Die KI analysiert automatisch RSS-Feeds von Kicker, Transfermarkt, Sport1, Sky Sports und Goal.com. Klicke auf <strong>„News abrufen"</strong> um die neuesten Meldungen zu laden.</span>
      </div>
